...
const ROUTE_WAYPOINTS = {
  austria_hungary: [
    ...
    { type: 'border', flag: '🇩🇪🇦🇹', name: 'Walserberg',        km: 130,  note: 'DE/AT · Schengen, keine Kontrolle · Vignette kaufen!' },
    ...
    { type: 'border', flag: '🇦🇹🇭🇺', name: 'Hegyeshalom',       km: 450,  note: 'AT/HU · Passkontrollen möglich · e-Matrica kaufen' },
    { type: 'city',   flag: '🇭🇺', name: 'Budapest',              km: 560,  note: 'M1/M5 Richtung Kelebia · MOL Tankstellen empfohlen' },
    { type: 'border', flag: '🇭🇺🇷🇸', name: 'Röszke / Horgoš',   km: 720,  note: 'HU/RS · Oft Wartezeit 30–120 Min! Passkontrolle' },
    ...
    { type: 'border', flag: '🇷🇸🇧🇬', name: 'Gradina / Kalotina', km: 1180, note: 'RS/BG · Passkontrollen · e-Vignette kaufen' },
    ...
    { type: 'border', flag: '🇧🇬🇹🇷', name: 'Kapıkule',           km: 1580, note: 'BG/TR · Wartezeit 1–4h · HGS kaufen · Passcheck' },
  ...
  croatia_route: [
    { type: 'city',   flag: '🇩🇪', name: 'München',               km: 0,    note: 'Start · A8 Richtung Salzburg' },
    { type: 'border', flag: '🇩🇪🇦🇹', name: 'Walserberg',         km: 130,  note: 'DE/AT · Schengen · Vignette kaufen' },
    ...
    { type: 'border', flag: '🇦🇹🇸🇮', name: 'Karawankentunnel',   km: 360,  note: 'AT/SI · Tunnelmaut 7,90€ · DarsGo Vignette kaufen' },
    { type: 'city',   flag: '🇸🇮', name: 'Ljubljana',              km: 430,  note: 'A1/E70 Richtung Zagreb · Günstiger tanken' },
    { type: 'border', flag: '🇸🇮🇭🇷', name: 'Bregana',            km: 520,  note: 'SI/HR · Schengen-intern · HR Maut beginnt' },
    ...
    { type: 'border', flag: '🇭🇷🇷🇸', name: 'Stara Gradiška',     km: 850,  note: 'HR/RS · Passkontrollen' },
    ...
    { type: 'border', flag: '🇷🇸🇧🇬', name: 'Gradina / Kalotina', km: 1280, note: 'RS/BG · e-Vignette kaufen' },
    { type: 'city',   flag: '🇧🇬', name: 'Sofia',                  km: 1380, note: 'Letzte große Stadt vor TR' },
    { type: 'border', flag: '🇧🇬🇹🇷', name: 'Kapıkule',            km: 1750, note: 'BG/TR · HGS kaufen · Wartezeit einplanen' },
  ...
  romania_route: [
    ...
    { type: 'border', flag: '🇦🇹🇭🇺', name: 'Hegyeshalom',        km: 510,  note: 'AT/HU · Passkontrollen · e-Matrica kaufen' },
    { type: 'city',   flag: '🇭🇺', name: 'Budapest',               km: 620,  note: 'M0 Ring · Richtung M35 / Debrecen' },
    { type: 'border', flag: '🇭🇺🇷🇴', name: 'Borș (Csanádpalota)', km: 820,  note: 'HU/RO · Passkontrollen · Rovinieta kaufen' },
    ...
    { type: 'border', flag: '🇷🇴🇧🇬', name: 'Giurgiu / Ruse',     km: 1380, note: 'RO/BG · Donaubrücke · e-Vignette kaufen' },
    { type: 'city',   flag: '🇧🇬', name: 'Varna / Russe',          km: 1480, note: 'Schwarzmeer-Küste oder Richtung Sofia/TR' },
    { type: 'border', flag: '🇧🇬🇹🇷', name: 'Kapıkule',            km: 1700, note: 'BG/TR · HGS kaufen · Passcheck' },
  ...
  greece_route: [
    ...
    { type: 'border', flag: '🇦🇹🇸🇮', name: 'Karawankentunnel',   km: 360,  note: 'AT/SI · Tunnelmaut 7,90€ · DarsGo kaufen' },
    { type: 'city',   flag: '🇸🇮', name: 'Ljubljana',              km: 430,  note: 'E75 Richtung Belgrad' },
    { type: 'border', flag: '🇸🇮🇷🇸', name: 'Šid / Batrovci',     km: 600,  note: 'SI/RS · Passkontrollen' },
    ...
    { type: 'border', flag: '🇷🇸🇲🇰', name: 'Preševo / Tabanovce', km: 980,  note: 'RS/MK · Kurze Kontrolle' },
    { type: 'city',   flag: '🇲🇰', name: 'Skopje',                 km: 1050, note: 'E75 Richtung Gevgelija · günstig tanken' },
    { type: 'border', flag: '🇲🇰🇬🇷', name: 'Gevgelija / Evzoni', km: 1150, note: 'MK/GR · Passkontrollen · GR Maut beginnt' },
    { type: 'city',   flag: '🇬🇷', name: 'Thessaloniki',           km: 1230, note: '★ Voll tanken vor teurer GR-Autobahn!' },
    { type: 'border', flag: '🇬🇷🇹🇷', name: 'Kipi / İpsala',      km: 1600, note: 'GR/TR · Passkontrollen · HGS kaufen' },
    { type: 'city',   flag: '🇹🇷', name: 'İstanbul',               km: 2100, note: 'Ziel' },
  ],
}
